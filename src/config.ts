...
export function loadConfig(): Config {
  ...
  const config: Config = {
    ...
    mmOrderRiskVwapBps: parseFloat(process.env.MM_ORDER_RISK_VWAP_BPS || '0'),
    mmOrderRiskVwapShares: parseFloat(process.env.MM_ORDER_RISK_VWAP_SHARES || '0'),
    mmOrderRiskVwapMult: parseFloat(process.env.MM_ORDER_RISK_VWAP_MULT || '0'),
    mmOrderRiskVwapLevels: parseInt(process.env.MM_ORDER_RISK_VWAP_LEVELS || '0'),
    mmOrderRiskVwapFeeBps: parseFloat(process.env.MM_ORDER_RISK_VWAP_FEE_BPS || '0'),
    mmOrderRiskVwapSlippageBps: parseFloat(process.env.MM_ORDER_RISK_VWAP_SLIPPAGE_BPS || '0'),
    mmPressureMaxRatio: parseFloat(process.env.MM_PRESSURE_MAX_RATIO || '0'),
    mmPressureSpreadWeight: parseFloat(process.env.MM_PRESSURE_SPREAD_WEIGHT || '0'),
    mmPressureOffsetWeight: parseFloat(process.env.MM_PRESSURE_OFFSET_WEIGHT || '0'),
    mmAutoTuneEnabled: process.env.MM_AUTO_TUNE_ENABLED === 'true',
    mmAutoTuneWindowMs: parseInt(process.env.MM_AUTO_TUNE_WINDOW_MS || '60000'),
    mmAutoTuneTargetFillRate: parseFloat(process.env.MM_AUTO_TUNE_TARGET_FILL_RATE || '0.02'),
    mmAutoTuneTargetCancelRate: parseFloat(process.env.MM_AUTO_TUNE_TARGET_CANCEL_RATE || '0.6'),
    mmAutoTuneUtilityTarget: parseFloat(process.env.MM_AUTO_TUNE_UTILITY_TARGET || '0.7'),
    mmAutoTuneUtilityDeadband: parseFloat(process.env.MM_AUTO_TUNE_UTILITY_DEADBAND || '0.15'),
    mmAutoTuneRewardWeight: parseFloat(process.env.MM_AUTO_TUNE_REWARD_WEIGHT || '1'),
    mmAutoTuneFillCostWeight: parseFloat(process.env.MM_AUTO_TUNE_FILL_COST_WEIGHT || '1'),
    mmAutoTuneCancelCostWeight: parseFloat(process.env.MM_AUTO_TUNE_CANCEL_COST_WEIGHT || '0.75'),
    mmAutoTuneRiskWeight: parseFloat(process.env.MM_AUTO_TUNE_RISK_WEIGHT || '0.6'),
    mmAutoTuneStep: parseFloat(process.env.MM_AUTO_TUNE_STEP || '0.05'),
    mmAutoTuneMinMult: parseFloat(process.env.MM_AUTO_TUNE_MIN_MULT || '0.6'),
    ...
    mmWsHealthCancelConfirmMultMin: parseFloat(process.env.MM_WS_HEALTH_CANCEL_CONFIRM_MULT_MIN || '1'),
    ...
    mmWsHealthEmergencyRecoveryMs: parseInt(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_MS || '45000'),
    mmWsHealthEmergencyRecoveryRatio: parseFloat(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_RATIO || '0.7'),
    mmWsHealthEmergencyRecoveryMinRatio: parseFloat(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_MIN_RATIO || '0.2'),
    mmWsHealthEmergencyRecoverySteps: parseInt(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_STEPS || '3'),
    mmWsHealthEmergencyRecoverySizeScaleMin: parseFloat(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SIZE_SCALE_MIN || '0.25'),
    mmWsHealthEmergencyRecoveryLayerCapMin: parseInt(process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_LAYER_CAP_MIN || '1'),
    mmWsHealthEmergencyRecoveryIntervalMultMax: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_INTERVAL_MULT_MAX || '2.5'
    ),
    mmWsHealthEmergencyRecoverySingleSide: (process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE || 'NONE') as Config['mmWsHealthEmergencyRecoverySingleSide'],
    mmWsHealthEmergencyRecoverySingleSideMode: (process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_MODE || 'REMOTE') as Config['mmWsHealthEmergencyRecoverySingleSideMode'],
    mmWsHealthEmergencyRecoverySingleSideExitProgress: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_EXIT_PROGRESS || '0.7'
    ),
    mmWsHealthEmergencyRecoveryDepthMult: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_DEPTH_MULT || '1.4'
    ),
    mmWsHealthEmergencyRecoveryVolatilityMultMin: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_VOLATILITY_MULT_MIN || '0.7'
    ),
    mmWsHealthEmergencyRecoverySpreadAdd: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SPREAD_ADD || '0.002'
    ),
    mmWsHealthEmergencyRecoveryIcebergRatio: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_ICEBERG_RATIO || '0.2'
    ),
    mmWsHealthEmergencyRecoveryCancelConfirmMultMin: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_CANCEL_CONFIRM_MULT_MIN || '1.4'
    ),
    ...
    mmWsHealthEmergencyRecoveryFarLayersMin: parseInt(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_FAR_LAYERS_MIN || '1'
    ),
    mmWsHealthEmergencyRecoveryCancelIntervalMultMax: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_CANCEL_INTERVAL_MULT_MAX || '2'
    ),
    mmWsHealthEmergencyRecoveryFarLayersMax: parseInt(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_FAR_LAYERS_MAX || '3'
    ),
    mmWsHealthEmergencyRecoveryLayerConvergeEnabled:
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_LAYER_CONVERGE_ENABLED === 'true',
    mmWsHealthEmergencyRecoveryTemplateEnabled:
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_TEMPLATE_ENABLED === 'true',
    mmWsHealthEmergencyRecoverySingleSideOffsetBps: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_OFFSET_BPS || '0'
    ),
    mmWsHealthEmergencyRecoverySingleSideOffsetMinBps: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_OFFSET_MIN_BPS || '0'
    ),
    mmWsHealthEmergencyRecoveryFarLayerStep: parseInt(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_FAR_LAYER_STEP || '1'
    ),
    mmWsHealthEmergencyRecoverySingleSideAuto:
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_AUTO === 'true',
    mmWsHealthEmergencyRecoverySingleSideImbalanceThreshold: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_SINGLE_SIDE_IMBALANCE_THRESHOLD || '0.15'
    ),
    mmWsHealthEmergencyRecoveryMinIntervalMs: parseInt(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_MIN_INTERVAL_MS || '0'
    ),
    mmWsHealthEmergencyRecoveryOffsetVolWeight: parseFloat(
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_OFFSET_VOL_WEIGHT || '1.2'
    ),
    mmWsHealthEmergencyRecoveryTemplateResetEnabled:
      process.env.MM_WS_HEALTH_EMERGENCY_RECOVERY_TEMPLATE_RESET_ENABLED === 'true',
    ...
    mmPriceAccelBps: parseFloat(process.env.MM_PRICE_ACCEL_BPS || '0'),
    mmPriceAccelWindowMs: parseInt(process.env.MM_PRICE_ACCEL_WINDOW_MS || '0'),
    ...
    mmLayerPanicOnlyFar: process.env.MM_LAYER_PANIC_ONLY_FAR === 'true',
    ...
    mmPanicCooldownMult: parseFloat(process.env.MM_PANIC_COOLDOWN_MULT || '1'),
    mmRestoreCooldownMult: parseFloat(process.env.MM_RESTORE_COOLDOWN_MULT || '1'),
    mmRestoreExitForceReprice: process.env.MM_RESTORE_EXIT_FORCE_REPRICE === 'true',
    mmPanicPauseMs: parseInt(process.env.MM_PANIC_PAUSE_MS || '0'),
    ...
    mmPanicSingleSideOffsetBps: parseFloat(process.env.MM_PANIC_SINGLE_SIDE_OFFSET_BPS || '0'),
    ...
    mmRestoreLayerCountCap: parseInt(process.env.MM_RESTORE_LAYER_COUNT_CAP || '0'),
    mmRestoreLayerStepBpsAdd: parseFloat(process.env.MM_RESTORE_LAYER_STEP_BPS_ADD || '0'),
    mmPanicRestoreLayerCountCap: parseInt(process.env.MM_PANIC_RESTORE_LAYER_COUNT_CAP || '0'),
    ...
    mmSafeModeEnabled: process.env.MM_SAFE_MODE_ENABLED === 'true',
    mmSafeModeVolBps: parseFloat(process.env.MM_SAFE_MODE_VOL_BPS || '0'),
    mmSafeModeDepthTrend: parseFloat(process.env.MM_SAFE_MODE_DEPTH_TREND || '0'),
    mmSafeModeSpreadMult: parseFloat(process.env.MM_SAFE_MODE_SPREAD_MULT || '1'),
    mmSafeModeStepMult: parseFloat(process.env.MM_SAFE_MODE_STEP_MULT || '1'),
    mmSafeModeCooldownMult: parseFloat(process.env.MM_SAFE_MODE_COOLDOWN_MULT || '1'),
    mmSafeModeOnlyFar: process.env.MM_SAFE_MODE_ONLY_FAR === 'true',
    mmSafeModeSizeScale: parseFloat(process.env.MM_SAFE_MODE_SIZE_SCALE || '0'),
    mmSafeModeSingleSide: (process.env.MM_SAFE_MODE_SINGLE_SIDE || 'NONE') as Config['mmSafeModeSingleSide'],
    mmSafeModeSingleSideMode: (process.env.MM_SAFE_MODE_SINGLE_SIDE_MODE || 'NORMAL') as Config['mmSafeModeSingleSideMode'],
    ...
    mmSafeModeDepthSpeedBps: parseFloat(process.env.MM_SAFE_MODE_DEPTH_SPEED_BPS || '0'),
    ...
    mmSafeModeTouchBufferBps: parseFloat(process.env.MM_SAFE_MODE_TOUCH_BUFFER_BPS || '0'),
    mmSafeModeOnlyFarLayers: parseInt(process.env.MM_SAFE_MODE_ONLY_FAR_LAYERS || '0'),
    mmSafeModeMinIntervalMs: parseInt(process.env.MM_SAFE_MODE_MIN_INTERVAL_MS || '0'),
    mmSafeModeMaxSharesPerOrder: parseFloat(process.env.MM_SAFE_MODE_MAX_SHARES_PER_ORDER || '0'),
    mmSafeModeDepthUsageMult: parseFloat(process.env.MM_SAFE_MODE_DEPTH_USAGE_MULT || '1'),
    mmSafeModeDepthCapMult: parseFloat(process.env.MM_SAFE_MODE_DEPTH_CAP_MULT || '1'),
    mmSafeModeNearTouchMult: parseFloat(process.env.MM_SAFE_MODE_NEAR_TOUCH_MULT || '1'),
    mmSafeModeAntiFillMult: parseFloat(process.env.MM_SAFE_MODE_ANTI_FILL_MULT || '1'),
    mmSafeModeNearTouchAddBps: parseFloat(process.env.MM_SAFE_MODE_NEAR_TOUCH_ADD_BPS || '0'),
    mmSafeModeCancelMult: parseFloat(process.env.MM_SAFE_MODE_CANCEL_MULT || '1'),
    mmSafeModePauseMs: parseInt(process.env.MM_SAFE_MODE_PAUSE_MS || '0'),
    mmSafeModeCancelThresholdMult: parseFloat(process.env.MM_SAFE_MODE_CANCEL_THRESHOLD_MULT || '1'),
    ...
    polymarketObservedQueueMinSamples: parseInt(process.env.POLYMARKET_OBSERVED_QUEUE_MIN_SAMPLES || '3'),
    polymarketObservedQueueMaxWeight: parseFloat(process.env.POLYMARKET_OBSERVED_QUEUE_MAX_WEIGHT || '0.65'),
    ...
    polymarketEventRiskPenaltyWithinMs: parseInt(process.env.POLYMARKET_EVENT_RISK_PENALTY_WITHIN_MS || String(4 * 60 * 60 * 1000)),
    polymarketEventRiskBlockWithinMs: parseInt(process.env.POLYMARKET_EVENT_RISK_BLOCK_WITHIN_MS || String(30 * 60 * 1000)),
    polymarketEventRiskPenaltyMax: parseFloat(process.env.POLYMARKET_EVENT_RISK_PENALTY_MAX || '6'),
    polymarketEventRiskSizeFactorMin: parseFloat(process.env.POLYMARKET_EVENT_RISK_SIZE_FACTOR_MIN || '0.45'),
    polymarketEventRiskRetreatMaxBps: parseFloat(process.env.POLYMARKET_EVENT_RISK_RETREAT_MAX_BPS || '10'),
    polymarketCatalystRiskPenaltyWithinMs: parseInt(process.env.POLYMARKET_CATALYST_RISK_PENALTY_WITHIN_MS || String(90 * 60 * 1000)),
    polymarketCatalystRiskBlockWithinMs: parseInt(process.env.POLYMARKET_CATALYST_RISK_BLOCK_WITHIN_MS || String(10 * 60 * 1000)),
    polymarketCatalystRiskPenaltyMax: parseFloat(process.env.POLYMARKET_CATALYST_RISK_PENALTY_MAX || '7'),
    polymarketCatalystRiskSizeFactorMin: parseFloat(process.env.POLYMARKET_CATALYST_RISK_SIZE_FACTOR_MIN || '0.35'),
    polymarketCatalystRiskRetreatMaxBps: parseFloat(process.env.POLYMARKET_CATALYST_RISK_RETREAT_MAX_BPS || '14'),
    polymarketGroupMaxExposureFactor: parseFloat(process.env.POLYMARKET_GROUP_MAX_EXPOSURE_FACTOR || '1.4'),
    polymarketGroupSoftExposureStart: parseFloat(process.env.POLYMARKET_GROUP_SOFT_EXPOSURE_START || '0.7'),
    polymarketGroupSizeFactorMin: parseFloat(process.env.POLYMARKET_GROUP_SIZE_FACTOR_MIN || '0.55'),
    polymarketGroupRetreatMaxBps: parseFloat(process.env.POLYMARKET_GROUP_RETREAT_MAX_BPS || '12'),
    polymarketThemeMaxExposureFactor: parseFloat(process.env.POLYMARKET_THEME_MAX_EXPOSURE_FACTOR || '2.2'),
    polymarketThemeSoftExposureStart: parseFloat(process.env.POLYMARKET_THEME_SOFT_EXPOSURE_START || '0.65'),
    polymarketThemeSizeFactorMin: parseFloat(process.env.POLYMARKET_THEME_SIZE_FACTOR_MIN || '0.5'),
    polymarketThemeRetreatMaxBps: parseFloat(process.env.POLYMARKET_THEME_RETREAT_MAX_BPS || '10'),
    ...
    polymarketCancelReasonRetreatMaxBps: parseFloat(
      process.env.POLYMARKET_CANCEL_REASON_RETREAT_MAX_BPS || '10'
    ),
  ...
  if (venue === 'polymarket') {
    ...
    if (
      ...
      (config.polymarketCancelReasonDominanceThreshold ?? 0) > 1
    ) {
      throw new Error('POLYMARKET_CANCEL_REASON_DOMINANCE_THRESHOLD must be within [0, 1]');
    }
    if ((config.polymarketCancelReasonRetreatMaxBps ?? 0) < 0) {
      throw new Error('POLYMARKET_CANCEL_REASON_RETREAT_MAX_BPS must be >= 0');
    }
    if (
      (config.polymarketCancelReasonSizeFactorMin ?? 0) <= 0 ||
  ...
  if ((config.mmWsHealthCancelMultMax ?? 0) < 1) {
    config.mmWsHealthCancelMultMax = 1;
  }
  ...
  if ((config.mmWsHealthCancelConfirmMultMin ?? 0) <= 0) {
    config.mmWsHealthCancelConfirmMultMin = 1;
  }
  if ((config.mmWsHealthCancelConfirmMultMin ?? 0) > 1) {
    config.mmWsHealthCancelConfirmMultMin = 1;
  }
  if ((config.mmWsHealthRepriceConfirmMultMin ?? 0) <= 0) {
  ...
  if ((config.mmWsHealthEmergencyRecoveryMs ?? 0) < 0) {
    config.mmWsHealthEmergencyRecoveryMs = 0;
  }
  if (config.mmWsHealthEmergencyRecoveryRatio !== undefined) {
    config.mmWsHealthEmergencyRecoveryRatio = Math.min(1, Math.max(0, config.mmWsHealthEmergencyRecoveryRatio));
  }
  if (config.mmWsHealthEmergencyRecoveryMinRatio !== undefined) {
    config.mmWsHealthEmergencyRecoveryMinRatio = Math.min(1, Math.max(0, config.mmWsHealthEmergencyRecoveryMinRatio));
  }
  if ((config.mmWsHealthEmergencyRecoverySteps ?? 0) < 1) {
    config.mmWsHealthEmergencyRecoverySteps = 1;
  }
  if (config.mmWsHealthEmergencyRecoverySizeScaleMin !== undefined) {
    config.mmWsHealthEmergencyRecoverySizeScaleMin = Math.min(
      1,
      Math.max(0, config.mmWsHealthEmergencyRecoverySizeScaleMin)
    );
  }
  if ((config.mmWsHealthEmergencyRecoveryLayerCapMin ?? 0) < 1) {
    config.mmWsHealthEmergencyRecoveryLayerCapMin = 1;
  }
  if (config.mmWsHealthEmergencyRecoveryIntervalMultMax !== undefined) {
    config.mmWsHealthEmergencyRecoveryIntervalMultMax = Math.max(1, config.mmWsHealthEmergencyRecoveryIntervalMultMax);
  }
  if (config.mmWsHealthEmergencyRecoverySingleSideExitProgress !== undefined) {
    config.mmWsHealthEmergencyRecoverySingleSideExitProgress = Math.min(
      1,
      Math.max(0, config.mmWsHealthEmergencyRecoverySingleSideExitProgress)
    );
  }
  if (config.mmWsHealthEmergencyRecoveryDepthMult !== undefined) {
    config.mmWsHealthEmergencyRecoveryDepthMult = Math.max(1, config.mmWsHealthEmergencyRecoveryDepthMult);
  }
  if (config.mmWsHealthEmergencyRecoveryVolatilityMultMin !== undefined) {
    config.mmWsHealthEmergencyRecoveryVolatilityMultMin = Math.min(
      1,
      Math.max(0.1, config.mmWsHealthEmergencyRecoveryVolatilityMultMin)
    );
  }
  if (config.mmWsHealthEmergencyRecoverySpreadAdd !== undefined) {
    config.mmWsHealthEmergencyRecoverySpreadAdd = Math.max(0, config.mmWsHealthEmergencyRecoverySpreadAdd);
  }
  if (config.mmWsHealthEmergencyRecoveryIcebergRatio !== undefined) {
    config.mmWsHealthEmergencyRecoveryIcebergRatio = Math.min(
      1,
      Math.max(0, config.mmWsHealthEmergencyRecoveryIcebergRatio)
    );
  }
  if (config.mmWsHealthEmergencyRecoveryCancelConfirmMultMin !== undefined) {
    config.mmWsHealthEmergencyRecoveryCancelConfirmMultMin = Math.max(
      1,
      config.mmWsHealthEmergencyRecoveryCancelConfirmMultMin
    );
  }
  if (config.mmWsHealthEmergencyRecoveryMaxOrdersMultMin !== undefined) {
    config.mmWsHealthEmergencyRecoveryMaxOrdersMultMin = Math.min(
      1,
  ...
  if ((config.mmWsHealthEmergencyRecoveryFarLayersMin ?? 0) < 1) {
    config.mmWsHealthEmergencyRecoveryFarLayersMin = 1;
  }
  if (config.mmWsHealthEmergencyRecoveryCancelIntervalMultMax !== undefined) {
    config.mmWsHealthEmergencyRecoveryCancelIntervalMultMax = Math.max(
      1,
      config.mmWsHealthEmergencyRecoveryCancelIntervalMultMax
    );
  }
  if ((config.mmWsHealthEmergencyRecoveryFarLayersMax ?? 0) < 1) {
    config.mmWsHealthEmergencyRecoveryFarLayersMax = 1;
  }
  if ((config.mmWsHealthEmergencyRecoveryFarLayerStep ?? 0) < 1) {
    config.mmWsHealthEmergencyRecoveryFarLayerStep = 1;
  }
  if (config.mmWsHealthEmergencyRecoverySingleSideOffsetBps !== undefined) {
    config.mmWsHealthEmergencyRecoverySingleSideOffsetBps = Math.max(
      0,
      config.mmWsHealthEmergencyRecoverySingleSideOffsetBps
    );
  }
  if (config.mmWsHealthEmergencyRecoverySingleSideOffsetMinBps !== undefined) {
    config.mmWsHealthEmergencyRecoverySingleSideOffsetMinBps = Math.max(
      0,
      config.mmWsHealthEmergencyRecoverySingleSideOffsetMinBps
    );
  }
  if (config.mmWsHealthEmergencyRecoverySingleSideImbalanceThreshold !== undefined) {
    config.mmWsHealthEmergencyRecoverySingleSideImbalanceThreshold = Math.max(
      0,
      config.mmWsHealthEmergencyRecoverySingleSideImbalanceThreshold
    );
  }
  if ((config.mmWsHealthEmergencyRecoveryMinIntervalMs ?? 0) < 0) {
    config.mmWsHealthEmergencyRecoveryMinIntervalMs = 0;
  }
  if (config.mmWsHealthEmergencyRecoveryOffsetVolWeight !== undefined) {
    config.mmWsHealthEmergencyRecoveryOffsetVolWeight = Math.max(
      0,
      config.mmWsHealthEmergencyRecoveryOffsetVolWeight
    );
  }
  if (config.mmWsHealthEmergencyRecoverySingleSideLossWeight !== undefined) {
    config.mmWsHealthEmergencyRecoverySingleSideLossWeight = Math.min(
      1,
