...
export interface Config {
  ...
  mmAutoTuneUtilityTarget?: number;
  mmAutoTuneUtilityDeadband?: number;
  mmAutoTuneRewardWeight?: number;
  mmAutoTuneFillCostWeight?: number;
  mmAutoTuneCancelCostWeight?: number;
  mmAutoTuneRiskWeight?: number;
  ...
  polymarketRewardNetSizeFactorMin?: number;
  ...
  polymarketEventRiskRetreatMaxBps?: number;
  ...
  polymarketCatalystRiskRetreatMaxBps?: number;
  polymarketGroupMaxExposureFactor?: number;
  polymarketGroupSoftExposureStart?: number;
  polymarketGroupSizeFactorMin?: number;
  polymarketGroupRetreatMaxBps?: number;
  polymarketThemeMaxExposureFactor?: number;
  polymarketThemeSoftExposureStart?: number;
  polymarketThemeSizeFactorMin?: number;
  polymarketThemeRetreatMaxBps?: number;
...
export interface Market {
  ...
  polymarket_reward_queue_model?: string;
  polymarket_reward_queue_confidence?: number;
  polymarket_reward_observed_queue_hours?: number;
  ...
  polymarket_event_risk_penalty?: number;
  polymarket_event_risk_reason?: string;
  polymarket_event_risk_source?: 'close' | 'catalyst';
  polymarket_event_time_to_close_ms?: number;
  polymarket_event_time_to_catalyst_ms?: number;
  polymarket_event_catalyst_label?: string;
  polymarket_event_risk_size_factor?: number;
  polymarket_group_utilization?: number;
  polymarket_theme_bucket?: string;
  polymarket_theme_utilization?: number;
  polymarket_theme_remaining_budget?: number;
  polymarket_theme_reason?: string;
